...
const NavBarTrans = () => {
  return (
    <nav className="py-6 xl:py-8 px-10 xl:px-20 border-gray-200 bg-transparent dark:border-gray-700 absolute top-0 left-0 right-0 z-10 transition-colors duration-500 ease-in-out group hover:bg-white hover:text-black">
      <div className="flex flex-wrap items-center justify-between w-full ">
        {/* Left side */}
        <div className="flex items-center w-1/3 gap-10">
          <button className="py-2 xl:text-xl relative group-hover:text-black flex items-center justify-center space-x-4">
