...
const page = () => {
  return (
    <div>
      ...
      <h1 className="text-6xl text-black mt-52 text-center">
        {" "}
      ...
      <div className="pt-24 mx-52 ">
        <Accordion>
          ...
          <div className="ml-10">
            <AccordionDetails>
              ...
              may be exchanged or returned for a full refund within thirty (30)
              days from the original purchase date except for high watches, high
              jewelry, and personalized or made-to-order items (including hot
              stamped or engraved products), which are final sale only.Returns
              or exchanges of jewelry must include the packaging, instructions
              leaflet (with warranty certificate), and product certificates
              (such as COSC and GIA).{" "}
            </AccordionDetails>
            <AccordionDetails>
              A refund of the original purchase price may only be made in the
              same form of payment, currency and country/region as the original
              purchase.
            </AccordionDetails>
            <AccordionDetails>
            ...
            <AccordionDetails>
              Merchandise purchased from a department store may only be refunded
              at the same department store brand or exchanged for product of
              equal or greater value at the same department store brand or a
              freestanding Aphrodite store.
            </AccordionDetails>
          </div>
        </Accordion>
        <Accordion>
          ...
          <div className="ml-10">
            ...
            <AccordionDetails>
              ...
              <ol className="list-disc ml-10">
                ...
                <li>
                  ...
                  package: Cover old address labels with the new pre-paid label
                  and securely seal your package using the adhesive strip on the
                  inside of the box.
                </li>
                <li>
                  {" "}
                  Deliver your package to UPS: Drop your package off at any UPS
                  store or pick-up location.
                </li>
              </ol>
            </AccordionDetails>
            <AccordionDetails>
              ...
              <ol className="list-disc ml-10">
                <li>
                  ...
                  team at concierge_delivery.us@contact.Aphrodite.com to request
                  a return.
                </li>
                <li> Please include your order number and phone number.</li>
                <li>
                  Schedule a pickup time: Our Client Services team will contact
                  you by phone to schedule a 2-hour time slot of your choice.
                </li>
                <li>
            ...
            <AccordionDetails>
              ...
              <ol className="list-disc ml-10">
                ...
                <li>
                  PayPal purchases may only be exchanged or returned for a full
                  refund at our online store.
                </li>
              </ol>
            </AccordionDetails>
          </div>
        ...
        <Accordion>
          ...
          <div className="ml-10">
            <AccordionDetails>
              Aphrodite offers complimentary returns & exchanges within 30 days
              of purchase. Item(s) must be in perfect & sellable condition,
              accompanied by the original packaging and documentation.
            </AccordionDetails>
            <AccordionDetails>
            ...
            <AccordionDetails>
              Register your return online or contact customer services: Register
              your return online by connecting to your account.
            </AccordionDetails>
            <AccordionDetails>
              ...
              within your order, on your package: Cover old address labels with
              the new pre-paid label and securely seal your package using the
              adhesive strip on the inside of the box. Should you need another
              return label, please contact Customer Services at &#40;
            ...
            <AccordionDetails>
              You may also visit any Free-Standing Aphrodite Stores to initiate
              your return.
            </AccordionDetails>
          </div>
        </Accordion>
          ...
          <div className="ml-10">
            <AccordionDetails>
              ...
              <h2>
                ...
                Fee: $30 for orders under $3,000 | Complimentary for all orders
                $3,000 and above Delivery Timing: Delivery Monday through Sunday
                (except holidays) from 11am to 9pm. Same-day service available
                for orders placed by 1pm ET for New York City or New Jersey.
                Your shopping bag will be hand delivered by our Concierge during
                a 2-hour time slot of your choice. You will receive SMS
                notifications regarding your order, and carrier charges may
                apply.
              </h2>
              <h2>Exceptions:</h2>
            ...
            <AccordionDetails>
              ...
              <h2>
                Fee: $30 for orders under $3,000 | Complimentary for all orders
                $3,000 and above Delivery Timing: Orders placed between 12pm ET
                on Monday and 3pm ET on Friday should arrive the following
                Saturday. If an order is placed after these times, it will be
                processed the following business day. Cutoff times may vary
                slightly depending on sourcing location.
              </h2>
              <h2>Exceptions:</h2>
              <ol className="list-disc ml-10">
                <li>
            ...
            <AccordionDetails>
              ...
              <h2>
                Fee: $30 for orders under $3,000 | Complimentary for all orders
                $3,000 and above Delivery Timing: Orders placed by 3pm ET Monday
                - Friday or by 11am ET Saturday should arrive the following
                business day. If an order is placed after these times, it will
                be processed the following business day. Cutoff times may vary
                slightly depending on sourcing location.
              </h2>
              <h2>Exceptions:</h2>
              <ol className="list-disc ml-10">
            ...
            <AccordionDetails>
              ...
              <h2>
                This delivery option has less carbon emissions than Air Delivery
                (on average for US mainland shipments).
              </h2>
              <h2>Fee: Complimentary for all orders</h2>
              <h2>
                Delivery Timing: 1-5 business days from the time you receive the
            ...
            <AccordionDetails>
              ...
              <ol className="list-disc ml-10">
                <li>
                  Collect-in-Store orders placed by 12pm (ET) Monday – Saturday
                  will be delivered to the store of your choice in 1 business
                  day for in-stock items​.
                </li>
                <li>
                  Collect in Store orders placed on Sunday will be processed the
            ...
            <AccordionDetails>
              ...
              <h2>
                Notification: You will receive an email when your order is ready
            ...
            <AccordionDetails>
              ...
              <h2>
                Ready-to-Wear Item: If you are picking up a Ready-to-Wear item,
                please note not all Louis Vuitton locations offer fitting rooms
                and alterations. Please check our STORE LOCATOR for a list of
                stores that sell Ready-to-Wear.
              </h2>
              <h2>
                If you do not collect your order: Your order will be available
                in-store for 14 days. If not collected, it will be sent back and
                your original method of payment will be refunded.
              </h2>
            </AccordionDetails>
            <AccordionDetails>
              ...
              <h2>
                ...
                your order. All prices reflect U.S. currency. Scheduled Delivery
                orders are delivered via our courier, all other orders are
                shipped by UPS.
              </h2>
            </AccordionDetails>
          </div>
        ...
        <Accordion>
          ...
          <div className="ml-10">
            <AccordionDetails>
              Payments are accepted via credit card, debit card, PayPal or Apple
              Pay with a valid United States billing and shipping address.
              Accepted credit cards are Visa, American Express, and Mastercard.
              When placing an order, your billing address must correspond to the
              address of your credit card, or we will not be able to process
              your order.
            </AccordionDetails>
          </div>
        </Accordion>
