  ...
  return (
    <div>
      ...
      <div className="bg-gray-300 pt-28 px-20 py-10 ml-3 mr-3">
        <h1 className="text-2xl text-black font-bold ">Navigation Bar</h1>

        <div className="grid lg:grid-cols-5 grid-cols-1 pt-10 text-black ">
          <div className="col-span-1 flex flex-col lg:pl-8 pt-8 sm:pb-5 ">
            <Link href="/  ">Menu</Link>
            <Link href="/">Contact Us</Link>
            <Link href="/">Cart</Link>
            <Link href="/">Account</Link>
          </div>
          <div className="col-span-1 flex flex-col sm:pb-5">
          ...
          <div className="col-span-1 flex flex-col sm:pb-5">
            <h5 className="text-lg font-bold">Account</h5>
      ...
      <div className="bg-gray-300 pt-3 px-20 py-10 mt-4 ml-3 mr-3">
        <h1 className="text-2xl text-black font-bold ">Browse</h1>

        <div className="grid lg:grid-cols-3 grid-cols-1 pt-10 text-black">
          <div className="col-span-1 flex flex-col pt-8 lg:pl-8 sm:pb-5">
            <Link href="/">Collection</Link>
            <Link href="/">Category</Link>
          </div>
          <div className="col-span-1 flex flex-col sm:pb-5 ">
            <h5 className="text-lg font-bold">Collection</h5>
